...
Primeiro temos que trabalhar nesse data set de modo a retirar a redundância dos dados, assim receberemos respostas menos enviesadas que poderiam nos levar a caminhos complicados.

# Removendo a redundância

Nosso dado possui certa redundância, principalmente por causa das diferentes cores entre os mesmos modelos de iPhones.

Podemos agrupar os dados pelos preços de vendas (que não se repetem) e escolher apenas o primeiro do nosso data set:
