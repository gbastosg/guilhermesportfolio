---
title: "Learning how to build Boxplots and ViolinPlots using R"
description: |
  In this post I am describing and showing how to analyse Boxplots and Violin Plots using the ggplot2 package in the R programming language.
author:
