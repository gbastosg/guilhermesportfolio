...
title: "Waffle Plot"
description: |
  Continuando a análise prévia sobre os dados de smartphones na Índia. Neste post continuarei explorando os dados em busca de perguntas e respostas que podem nos levar a resultados interessantes. 
author:
...
Antes, vamos responder a nossa pergunta usando o simples comandos em R:
...
E claro, se quisermos saber quem são os Top 10 podemos simplesmente usar a função `head()`:
...
Info-gráficos são bastante úteis para mostrar informações rápidas com clareza. Aqui por exemplo vemos o quão influente foi a Redmi no mercado Indiano daquele ano.
