...
Então é isso, parece que a dose da vitamina C tem efeito direto sobre o crescimento do dente dos ratos, na verdade não... o que realmente acontece é que se repetíssemos o experimento com diferentes grupos de ratos, provavelmente obteríamos uma resposta diferente daquela que observamos previamente.
...
abline(v=diferenca_observavel1, col="yellow", lwd=2)

abline(v=diferenca_observavel2, col="red", lwd=2)
```
