...
Podemos fazer isso para construir uma distribuição completamente aleatória a partir dos nossos dados
...
Conforme dito anteriormente precisamos nos manter céticos, para isso partimos do pressuposto de que aleatoriamente a diferença que observada poderia não significar muito, ou seja, poderia ser algo observado ao acaso. 
