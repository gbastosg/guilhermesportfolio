...
This is pretty useful when we are dealing with a lot of data and to organise our analyses.
...
>In the next post:
>One of the easiest ways of comparing data is by using graphs. On the next post I'm going to use ggplot to create some graphs and compare results.
